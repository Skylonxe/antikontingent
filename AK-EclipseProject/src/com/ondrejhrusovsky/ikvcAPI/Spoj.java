...
public class Spoj
{
	...
	{		
        ...
        if(!vysledok.asText().contains("Registračné číslo") && !vysledok.asText().contains("Vyčerpaný kontingent!"))
        {
        	chybaNacitaniaKontingentu = true;
        	throw new NemoznoZakupitListokException("Pri pokuse o zakupenie listka sme dostali neocakavany vysledok");
        }
		
        final boolean bVycerpany = vysledok.asText().contains("Vyčerpaný kontingent!");
